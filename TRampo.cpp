...
void chamarquicksort(int* vet, int inicio, int fim ,dado *dados);

void quicksort (int* vet, int inicio, int fim );

void bubblesort(int vet[],long int n,dado *dados);
...
/*Selecione o temanho do vetor*/
   ...
   printf ("*** Ordenacao ***\n\n");
      ...
      printf ("Selecione o tamanho do vetor(10000-1)(100000-2)(1000000-3): ");
	  ...
	  chamarquicksort(Vet2,0,tam,dados);
	  
	  bubblesort(Vet3,tam,dados);
...
int particiona(int* vet, int inicio, int fim){
	...
	esq=inicio;dir=fim;pivo=vet[inicio];
...
void chamarquicksort(int* vet, int inicio, int fim,dado *dados){
	...
	dados[4].tempo=((tf-t0)/(CLOCKS_PER_SEC/1000));
...
void bubblesort(int vet[],long int n,dado *dados){
	...
	dados[5].tempo=((tf-t0)/(CLOCKS_PER_SEC/1000));
